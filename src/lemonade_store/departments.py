...
_DEPARTMENTS: tuple[Department, ...] = (
    ...
    Department(
        ...
        owns=(
            "local security policy checks",
            "agent permission audits",
            "GenAI data-risk findings",
            "AI bill-of-materials manifests",
            "model and tool inventory",
            "privacy boundary checks",
            "offline security reports",
        ...
        emits=(
            ...
            "security.aibom.generated",
            "security.audit.completed",
        ),
        agents=("auditor", "aibom"),
        requires_owner_approval_for=("export_report", "share_finding"),
        reads=(
            "cashier.",
            "accounting.",
            "inventory.",
